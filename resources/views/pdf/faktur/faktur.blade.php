...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-7 justify-content-end d-flex" style="flex-direction: column">
                <span class="fw-bold" style="font-size: xx-large; align-self: flex-end">SURAT JALAN</span>
                <span class="fw-bold" style="font-size: small; align-self: flex-end">Tgl. 12 Maret 2024</span>
                <span
                    style="align-self: flex-end; font-size: large; font-weight: 600">0001/SJ-REPAIR/ARMDN/03/2024</span>
            </div>
        </div>
        <div class="row mt-5">
          ...
          <p class="fw-normal" style="font-size: medium">
            ...
            <div class="col-3 d-flex flex-column align-items-start">
                <span class="fw-bold" style="font-size: medium">Detail Pembeli&nbsp;:</span>
                <span class="fw-normal" style="font-size: medium">Indent Unit</span>
                <span class="fw-normal" style="font-size: medium">{{ $indent->indent_number }}</span>
                <span class="fw-normal" style="font-size: medium">Tgl Indent&nbsp;:
                    {{ date('d M Y', strtotime($indent->created_at)) }}</span>
            </div>
        </div>
