                    ...
                    <div class="col-span-2 lg:col-span-1">
                        <div class="grid grid-cols-12  gap-6">
                            ...
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">: {{ $data->spk_instansi_payment_for }}</p>
                            </div>
                            <div class="lg:col-span-6 col-span-6">
                                <p class="detail-label">Jenis</p>
                            </div>
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">: {{ $data->spk_instansi_payment_type }}</p>
                            </div>
                            ...
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">: {{ $data->spk_instansi->spk_instansi_general->po_number ?? '-' }}
                                </p>
                            </div>
                            <div class="lg:col-span-6 col-span-6">
                            ...
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">:
                                    {{ $data->spk_instansi->indent_instansi->indent_instansi_name ?? '-' }}</p>
                            </div>
                            <div class="lg:col-span-6 col-span-6">
                                <p class="detail-label">Nama STNK</p>
                            </div>
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">: {{ $data->spk_instansi->spk_instansi_legal->instansi_name }}</p>
                            </div>
                            <div class="lg:col-span-6 col-span-6">
                                <p class="detail-label">No. Telp</p>
                            </div>
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">: {{ $data->spk_instansi->spk_instansi_general->no_telp ?? '-' }}
                                </p>
                            </div>
                            <div class="lg:col-span-6 col-span-6">
                            ...
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">: {{ $data->spk_instansi->spk_instansi_general->no_hp ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-2 lg:col-span-1 mt-8 lg:mt-0">
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-12 lg:col-span-12 flex justify-between">
                                <p class="detail-title">DETAIL PEMBAYARAN</p>
                                <p class="detail-title text-uppercase">{{ $data->spk_instansi_payment_status }}</p>
                            </div>
                            <div class="lg:col-span-6 col-span-6">
                            ...
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label font-semibold">: Rp
                                    {{ number_format($data->spk_instansi->spk_instansi_general->po_values, 0, ',', '.') }}
                                </p>
                            </div>
                            <div class="lg:col-span-6 col-span-6">
                            ...
                            <div class="col-span-6 lg:col-span-6">
                                ...
                                @foreach ($data->spk_instansi->spk_instansi_payment->spk_instansi_payment_list as $payment)
                                    @php
                                        $totalAmount += $payment->payment_list_amount;
                                    @endphp
                                @endforeach
                            ...
                            <div class="col-span-6 lg:col-span-6">
                                <p class="detail-label">:
                                    {{ $data->spk_instansi->spk_instansi_general->po_values - $totalAmount }}</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr class="border-t border-stroke py-4.5 px-4 md:px-6 2xl:px-7.5 items-center">
                                            <td class="text-sm px-5 items-center text-black text-center py-2 capitalize">
                                                <div class=" items-center text-center">
                                                    <span>{{ $payment->payment_list_number }}</span>
                                                </div>
                                            </td>
                                            <td class="text-sm px-5 items-center text-black text-center py-2 capitalize">
                                                <div class=" items-center text-center">
                                                    <span>{{ $payment->payment_list_date }}</span></div>
                                            </td>
                                            <td class="text-sm px-5 items-center text-black text-center py-2 capitalize">
                                                <div class=" items-center text-center"><span class="whitespace-nowrap">Rp
                                                        {{ number_format($payment->payment_list_amount, 0, ',', '.') }}</span>
                                                </div>
                                            </td>
                                            <td class="text-sm px-5 items-center text-black text-center py-2 capitalize">
                                                <div class=" items-center text-center text-uppercase">
                                                    <span>{{ $payment->payment_list_method }}</span></div>
                                            </td>
                                            <td class="text-sm px-5 items-center text-black text-center py-2 capitalize">
                                                <div class=" items-center text-center">
                                                    <span>{{ $payment->bank->bank_name ?? '-' }}</span></div>
                                            </td>
