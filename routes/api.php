...
Route::prefix("v1")->group(function () {
    ...
    Route::middleware("auth:sanctum")->group(function () {
        ...
        Route::prefix("user")->group(function () {
            ...
            Route::get("/user-permission", [UserController::class, "getPermissionUser"])->middleware('permission:user_list.read_permission_user');
        ...
        Route::prefix("master")->group(function () {
            ...
            Route::prefix("bank")->group(function () {
                ...
                Route::put("/status/{id}", [Master::class, "statusBank"])->middleware('permission:put_status_bank_master');
                Route::put("/update/{id}", [Master::class, "updateBank"])->middleware('permission:put_bank_master');
            });
        ...
        Route::prefix("po-instansi")->group(function () {
            ...
            Route::prefix("payment")->group(function () {
                ...
                Route::post("/status/{id}", [SpkInstansiController::class, "updateStatusPayment"])->middleware("permission:update_status_payment_spk_inst");
