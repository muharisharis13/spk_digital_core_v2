...
Route::prefix("v1")->group(function () {
    ...
    Route::middleware("auth:sanctum")->group(function () {
        ...
        Route::prefix("user")->group(function () {
            ...
            // ->middleware('permission:user_list.read_permission_user');
            Route::get("/current-dealer", [UserController::class, "getCurrentDealer"]);
            // ->middleware('permission:get_current_dealer_user');
            ...
            // ->middleware("permission:get_role_user");
            Route::put("/status/{id}", [UserController::class, "updateStatus"]);
            // ->middleware("permission:put_status_user");
            Route::get("/list", [UserController::class, "getUserList"]);
            // ->middleware("permission:get_user");
            Route::get("/detail/{id}", [UserController::class, "getUserDetail"]);
            // ->middleware("permission:get_detail_user");
            Route::post("/create", [UserController::class, "createuser"]);
            // ->middleware("permission:post_user");
            Route::put("/update/{id}", [UserController::class, "updateUser"]);
            // ->middleware("permission:put_user");
        ...
        Route::prefix("shipping-order")->group(function () {
            ...
            // ->middleware('permission:read_shipping_order_detail');
        });
        ...
        Route::prefix("unit")->group(function () {
            ...
            Route::prefix("pricelist")->group(function () {
                ...
                // ->middleware('permission:get_pricelist');
                Route::get("/detail/{id}", [UnitContoller::class, "getDetailPriceList"]);
                // ->middleware('permission:get_detail_pricelist');
        ...
        Route::prefix("master")->group(function () {
            ...
            // ->middleware('permission:read_motor_master');
            ...
            Route::prefix("sales")->group(function () {
                ...
                // ->middleware('permission:get_sales_master');
            });
            Route::prefix("microfinance")->group(function () {
                Route::get("/list", [Master::class, "getMicrofinance"]);
                // ->middleware('permission:get_miscrofinance_master');
            });
            Route::prefix("leasing")->group(function () {
                Route::get("/list", [Master::class, "getLeasing"]);
                // ->middleware('permission:get_leasing_master');
            });
            Route::prefix("color")->group(function () {
                Route::get("/list", [Master::class, "getColor"]);
                // ->middleware('permission:get_color_master');
            });
            Route::prefix("bank")->group(function () {
                Route::get("/list", [Master::class, "getBank"]);
                // ->middleware('permission:get_bank_master');
                Route::post("/create", [Master::class, "createBank"]);
                // ->middleware('permission:post_bank_master');
                Route::put("/status/{id}", [Master::class, "statusBank"]);
                // ->middleware('permission:put_status_bank_master');
                Route::put("/update/{id}", [Master::class, "updateBank"]);
                // ->middleware('permission:put_bank_master');
            });
            Route::prefix("marital")->group(function () {
                Route::get("/list", [Master::class, "getListMaritalStatus"]);
                // ->middleware('permission:get_marital_master');
            });
            Route::prefix("hobby")->group(function () {
                Route::get("/list", [Master::class, "getListHobby"]);
                // ->middleware('permission:get_hobby_master');
            });
            Route::prefix("tenor")->group(function () {
                Route::get("/list", [Master::class, "getListTenor"]);
                // ->middleware('permission:get_tenor_master');
            });
            ...
            Route::prefix("motor-brand")->group(function () {
                ...
                // ->middleware('permission:get_motor_brand_master');
            });
            Route::prefix("motor")->group(function () {
                Route::get("/detail/{id}", [Master::class, "getDetailMotor"]);
                // ->middleware('permission:get_motor_detail_master');
            });
        });
        ...
        Route::prefix("indent-instansi")->group(function () {
            ...
            // ->middleware('permission:get_detail_indent_inst');
        ...
        Route::prefix("spk")->group(function () {
            ...
            // ->middleware('permission:read_spk');
            Route::get("/detail/{spk_id}", [SPKController::class, "getDetailSpk"]);
            // ->middleware('permission:read_spk_detail');
            ...
            // ->middleware('permission:post_cro_spk');
        ...
        Route::prefix("retur-unit")->group(function () {
            ...
            // ->middleware('permission:read_retur_unit_detail');
        ...
        Route::prefix("po-instansi")->group(function () {
            ...
            // ->middleware('permission:get_po_inst');
            Route::post("/cro/{id}", [SpkInstansiController::class, "addCRO"]);
            // ->middleware('permission:post_add_cro_po_inst');
            Route::get("/detail/{id}", [SpkInstansiController::class, "getDetail"]);
            // ->middleware('permission:get_detail_po_inst');
            ...
            Route::prefix("payment")->group(function () {
                ...
                // ->middleware('permission:get_detail_payment_po_inst');
                ...
                // ->middleware("permission:update_status_payment_spk_inst");
                Route::get("/list", [SpkInstansiController::class, "getPaginatePayment"]);
                // ->middleware('permission:get_payment_po_inst');
            });
        ...
        Route::prefix("spk-instansi")->group(function () {
            ...
            // ->middleware('permission:get_spk_inst');
            Route::get("/detail/{id}", [SpkInstansiController::class, "getDetailSpkInstansiUnit"]);
            // ->middleware('permission:get_detail_spk_inst');
        });
